...
import com.wikipy.web.ValueConverter;
...
public class ScriptExecService {
	 ...
	 */
	public Object executeScript(Script script, Map<String, Object> model,
			boolean secure) {
	...
	public Script compile(String webScript, String id) {
        ...
        try
        {
            ...
            Script script = cx.compileString(webScript, id, 1, null);
