...
public class AuthenticationUtil
{
    ...
    public static ThreadLocal<String> country = new ThreadLocal<String>();
    public static ThreadLocal<String> region =  new ThreadLocal<String>();
    public static ThreadLocal<String> city =  new ThreadLocal<String>();
    public static ThreadLocal<String> latitude =  new ThreadLocal<String>();
