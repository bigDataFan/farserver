...
public final class QName implements Serializable, Cloneable, Comparable<QName>
{
    ...
    public QName(String namespaceURI, String localName, Boolean b) {
		this.namespaceURI = namespaceURI;
		this.localName = localName;
		isArray = b;
	}
    ...
    public static QName createQName(String namespaceURI, String localName, Boolean isArray)
    {
        if (localName == null || localName.length() == 0)
        {
            throw new IllegalArgumentException("A QName must consist of a local name");
        }
        return new QName(namespaceURI, localName, isArray);
    }
