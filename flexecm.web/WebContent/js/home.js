...
function addCrumb(name, id, isRoot) {
	...
	li.find("span").html($(name).short(10));
	li.data("eid", id);
...
function initUploader() {
	...
	imgUploader.bind('FileUploaded', function(up, file, info) {
		var entity = JSON.parse(info.response);
		$("#preview-img").data("entity",  entity);
		$("#preview-img").attr("src", "/service/file/download?id=" + entity._id );
