    ...
    $.fn.tagSuggest = function (options) {
        ...
        return this.each(function () {
            ...
            function chooseTag(tag) {
                ...
                */
            	var lstp = tagsElm.val().lastIndexOf(settings.separator);
            	if (lstp>0) {
            		tagsElm.val(tagsElm.val().substring(0,lstp) + settings.separator + tag);
            	} else {
            		tagsElm.val(tag);
            	}
                tagsElm.blur().focus();
